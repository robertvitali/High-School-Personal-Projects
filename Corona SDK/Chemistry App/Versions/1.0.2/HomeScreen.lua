...
function scene:create (event)
	...
	lists = display.newText("Convert", 6*width1/7, whiteBar.y, native.systemFontBold, 40)
	...
	button2 = display.newText("", 1.25*width1/6, numberButton1.y - 100, native.systemFontBold, 80)
	button1 = display.newText("", 3*width1/6, numberButton1.y - 100, native.systemFontBold, 80)
	button3 = display.newText("", 4.75*width1/6, numberButton1.y - 100, native.systemFontBold, 80)
	...
	local function timeTracker()
		localData.time = localData.time + 1
		if localData.time > 500 then
			localData.time = 0
			adsFunction()
		end
		table.save(localData, "localDataSaved")
