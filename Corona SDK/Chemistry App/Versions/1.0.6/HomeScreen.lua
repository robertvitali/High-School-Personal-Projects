...
function scene:create (event)
	...
	--Lists
	lists = display.newText("Convert", 6*display.contentWidth/7, whiteBar.y, native.systemFontBold, display.contentHeight/25)
		lists.x = 3*display.contentWidth/4 + lists.width/3
