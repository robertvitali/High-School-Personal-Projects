...
function scene:create (event)
	...
	local notes1 = native.newTextBox(display.contentWidth/2 - 4, display.contentHeight/3.3 - 4, display.contentWidth - 20, display.contentHeight/2)
	notes1.text = UserInfo.notes
	notes1.size=40
	notes1:setTextColor(0,0,0)
	notes1:setReturnKey("done")

	local rectangle1 = display.newRoundedRect(notes1.x, notes1.y, notes1.width + 15, notes1.height + 15, 26)
