...
function scene:create (event)
	...
	local notesText = display.newText("Message: ", 0, display.contentHeight/2 - 140, nil, 23)
	...
	local function contactListener( event )
			...
			notesText.alpha = 0
			notes1.text = ""
			encrypt.y = display.contentHeight/2 + 1.6*display.contentHeight/5
        	scrollView:scrollToPosition
			{
    			y = -100,
    			time = 100,
			}
			encrypt.y = encrypt.y - 25
