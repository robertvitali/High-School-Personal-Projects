...
function scene:create (event)
	...
	local encryptBackground = display.newRoundedRect(display.viewableContentWidth/2, display.contentHeight/2 + 1.9*display.contentHeight/5, encrypt.width*1.3, encrypt.height *1.25, 250)
	...
	local function contactListener( event )
			...
			--for ipad
			encrypt.y = encrypt.y - 30
			encryptBackground.y = encryptBackground.y - 30
