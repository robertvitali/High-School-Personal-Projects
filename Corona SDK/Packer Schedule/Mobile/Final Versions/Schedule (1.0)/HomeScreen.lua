...
local function ButtonTap1 (event)
	composer.gotoScene("Day1", {effect = "slideLeft", time = 300})
end

local function ButtonTap2 (event)
	composer.gotoScene("Day2", {effect = "slideLeft", time = 300})
end

local function ButtonTap3 (event)
	composer.gotoScene("Day3", {effect = "slideLeft", time = 300})
end

local function ButtonTap4 (event)
	composer.gotoScene("Day4", {effect = "slideLeft", time = 300})
end

local function ButtonTap5 (event)
	composer.gotoScene("Day5", {effect = "slideLeft", time = 300})
end

local function ButtonTap6 (event)
	composer.gotoScene("Day6", {effect = "slideLeft", time = 300})
end

local function ButtonTap7 (event)
	composer.gotoScene("Day7", {effect = "slideLeft", time = 300})
end
