...
function scene:create (event)
	...
	local temp = display.newText(UserInfo.myBreak, display.contentWidth/2, display.contentHeight-430, native.systemFont, 20)
...
--[[	local notesBorder = display.newRect(display.contentWidth/2, display.contentHeight/2-50, 312, 227)
	...
	breakGroup1:insert(background)
	breakGroup1:insert(temp)
	breakGroup1:insert(back)
	breakGroup1:insert(save)
	breakGroup1:insert(reset)
	breakGroup1:insert(notesText)
	breakGroup1:insert(notes1)
--	breakGroup1:insert(notesBorder)
	...
	local function saveButton(event)
		UserInfo.breakTasks = notes1.text
