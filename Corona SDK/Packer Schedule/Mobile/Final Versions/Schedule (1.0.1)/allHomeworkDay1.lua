...
function scene:create (event)
	...
	local temp = display.newText("All Notes from Day 1", display.contentWidth/2, display.contentHeight-460, native.systemFont, 20)
...
--	temp:setFillColor(0,0,0)
	...
	local notes1 = display.newText(UserInfo.aBand.." Homework: "..UserInfo.aBandHomework, display.contentWidth/2, display.contentHeight/2 - 130, nil, 20)
		notes1:setFillColor(1,1,1)

	if(UserInfo.dBand == "") then
		UserInfo.dBand = "D Band"
	end
	local notes2 = display.newText(UserInfo.dBand.." Homework: "..UserInfo.dBandHomework, display.contentWidth/2, display.contentHeight/2 - 90, nil, 20)
	...
	local notes5 = display.newText(UserInfo.gBand.." Homework: "..UserInfo.gBandHomework, display.contentWidth/2, display.contentHeight/2 + 30, nil, 20)
		notes5:setFillColor(1,1,1)

	if(UserInfo.cBand == "") then
		UserInfo.cBand = "C Band"
	end
	local notes6 = display.newText(UserInfo.cBand.." Homework: "..UserInfo.cBandHomework, display.contentWidth/2, display.contentHeight/2 + 70, nil, 20)
	...
	local notes9 = display.newText(UserInfo.bBand.." Homework: "..UserInfo.bBandHomework, display.contentWidth/2, display.contentHeight/2 + 190, nil, 20)
