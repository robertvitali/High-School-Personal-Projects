...
function scene:create (event)
	...
	local temp = display.newText("All Notes from Day 2", display.contentWidth/2, display.contentHeight-460, native.systemFont, 20)
...
--	temp:setFillColor(0,0,0)
	...
	local notes1 = display.newText(UserInfo.bBand.." Homework: "..UserInfo.bBandHomework, display.contentWidth/2, display.contentHeight/2 - 130, nil, 20)
		notes1:setFillColor(1,1,1)

	if(UserInfo.eBand == "") then
		UserInfo.eBand = "E Band"
	end
	local notes2 = display.newText(UserInfo.eBand.." Homework: "..UserInfo.eBandHomework, display.contentWidth/2, display.contentHeight/2 - 90, nil, 20)
	...
	local notes6 = display.newText(UserInfo.fBand.." Homework: "..UserInfo.fBandHomework, display.contentWidth/2, display.contentHeight/2 + 70, nil, 20)
	...
	local notes9 = display.newText(UserInfo.cBand.." Homework: "..UserInfo.cBandHomework, display.contentWidth/2, display.contentHeight/2 + 190, nil, 20)
