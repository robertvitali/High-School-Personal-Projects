...
--	temp:setFillColor(0,0,0)
	...
	local notes1 = display.newText(UserInfo.cBand.." Homework: "..UserInfo.cBandHomework, display.contentWidth/2, display.contentHeight/2 - 130, nil, 20)
	...
	local notes9 = display.newText(UserInfo.dBand.." Homework: "..UserInfo.dBandHomework, display.contentWidth/2, display.contentHeight/2 + 190, nil, 20)
