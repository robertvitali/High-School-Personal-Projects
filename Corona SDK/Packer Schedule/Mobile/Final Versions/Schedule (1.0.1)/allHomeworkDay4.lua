...
--	temp:setFillColor(0,0,0)
	...
	local notes1 = display.newText(UserInfo.dBand.." Homework: "..UserInfo.dBandHomework, display.contentWidth/2, display.contentHeight/2 - 130, nil, 20)
		notes1:setTextColor(1,1,1)

	if(UserInfo.aBand == "") then
		UserInfo.aBand = "A Band"
	end
	local notes2 = display.newText(UserInfo.aBand.." Homework: "..UserInfo.aBandHomework, display.contentWidth/2, display.contentHeight/2 - 90, nil, 20)
	...
	local notes9 = display.newText(UserInfo.eBand.." Homework: "..UserInfo.eBandHomework, display.contentWidth/2, display.contentHeight/2 + 190, nil, 20)
