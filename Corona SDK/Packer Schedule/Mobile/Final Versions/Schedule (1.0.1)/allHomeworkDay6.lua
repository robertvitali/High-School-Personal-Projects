...
--	temp:setFillColor(0,0,0)
	...
	local notes1 = display.newText(UserInfo.fBand.." Homework: "..UserInfo.fBandHomework, display.contentWidth/2, display.contentHeight/2 - 130, nil, 20)
		notes1:setFillColor(1,1,1)

	if(UserInfo.cBand == "") then
		UserInfo.cBand = "C Band"
	end
	local notes2 = display.newText(UserInfo.cBand.." Homework: "..UserInfo.cBandHomework, display.contentWidth/2, display.contentHeight/2 - 90, nil, 20)
	...
	local notes5 = display.newText(UserInfo.dBand.." Homework: "..UserInfo.dBandHomework, display.contentWidth/2, display.contentHeight/2 + 30, nil, 20)
		notes5:setFillColor(1,1,1)

	if(UserInfo.aBand == "") then
		UserInfo.aBand = "A Band"
	end
	local notes6 = display.newText(UserInfo.aBand.." Homework: "..UserInfo.aBandHomework, display.contentWidth/2, display.contentHeight/2 + 70, nil, 20)
