...
function scene:create (event)
	...
	local notes1 = native.newTextBox(display.contentWidth/2, notesText.y + startHeight9, 310, 45)
	...
	local notes2 = native.newTextBox(display.contentWidth/2, notesText.y + 2*startHeight9, 310, 45)
	notes2.text = UserInfo.dBand.." Homework: "..UserInfo.dBandHomework
	...
	local notes3 = native.newTextBox(display.contentWidth/2, notesText.y + 3*startHeight9, 310, 45)
	...
	local notes4 = native.newTextBox(display.contentWidth/2, notesText.y + 4*startHeight9, 310, 45)
	...
	local notes5 = native.newTextBox(display.contentWidth/2, notesText.y + 5*startHeight9, 310, 45)
	notes5.text = UserInfo.gBand.." Homework: "..UserInfo.gBandHomework
	...
	local notes6 = native.newTextBox(display.contentWidth/2, notesText.y + 6*startHeight9, 310, 45)
	...
	local notes7 = native.newTextBox(display.contentWidth/2, notesText.y + 7*startHeight9, 310, 45)
	...
	local notes8 = native.newTextBox(display.contentWidth/2, notesText.y + 8*startHeight9, 310, 45)
	...
	local notes9 = native.newTextBox(display.contentWidth/2, notesText.y + 9*startHeight9, 310, 45)
	notes9.text = UserInfo.bBand.." Homework: "..UserInfo.bBandHomework
