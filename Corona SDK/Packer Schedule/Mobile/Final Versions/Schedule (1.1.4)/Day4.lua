...
function scene:create (event)
	...
	local cell1 = display.newRect(display.contentWidth/2, 2*height + 15, 150, 30)
		local dBandText4 = display.newText("D Band", display.contentWidth/2, cell1.y, nil, 16)
		local dBandTime4 = display.newText("8:10 - 9:00", cell1.x - 120, cell1.y, nil, 12)
	...
	local cell2 = display.newRect(display.contentWidth/2, 3*height + 30, 150, 30)
		local aBandText4 = display.newText("A Band", display.contentWidth/2, cell2.y, nil, 16)
		local aBandTime4 = display.newText("9:05 - 9:55", cell2.x - 120, cell2.y, nil, 12)
	...
	local cell3 = display.newRect(display.contentWidth/2, 4*height + 45, 150, 30)
		...
		local advisingTime4 = display.newText("9:55 - 10:15", cell3.x - 120, cell3.y, nil, 12)
	...
	local cell4 = display.newRect(display.contentWidth/2, 5*height + 60, 150, 30)
		...
		local breakTime4 = display.newText("10:15 - 10:35", cell4.x - 120, cell4.y, nil, 12)
	...
	local cell5 = display.newRect(display.contentWidth/2, 6*height + 75, 150, 30)
		local gBandText4 = display.newText("G Band", display.contentWidth/2, cell5.y, nil, 16)
		local gBandTime4 = display.newText("10:35 - 11:25", cell5.x - 120, cell5.y, nil, 12)
	...
	local cell6 = display.newRect(display.contentWidth/2, 7*height + 90, 150, 30)
		local cBandText4 = display.newText("C Band", display.contentWidth/2, cell6.y, nil, 16)
		local cBandTime4 = display.newText("11:30 - 12:20", cell6.x - 120, cell6.y, nil, 12)
	...
	local cell9 = display.newRect(display.contentWidth/2, 10*height+135, 150, 30)
		local eBandText4 = display.newText("E Band", display.contentWidth/2, cell9.y, nil, 16)
		local eBandTime4 = display.newText("1:45 - 3:15", cell9.x - 120, cell9.y, nil, 12)
