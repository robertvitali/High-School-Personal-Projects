...
function scene:create (event)
	...
	local cell1 = display.newRect(display.contentWidth/2, 2*height+15, 150, 30)
		local eBandText5 = display.newText("E Band", display.contentWidth/2, cell1.y, nil, 16)
		local eBandTime5 = display.newText("8:10 - 9:00", cell1.x - 120, cell1.y, nil, 10)
	...
	local cell2 = display.newRect(display.contentWidth/2, 3*height +30, 150, 30)
		local bBandText5 = display.newText("B Band", display.contentWidth/2, cell2.y, nil, 16)
		local bBandTime5 = display.newText("9:05 - 9:55", cell2.x - 120, cell2.y, nil, 10)
	...
	local cell3 = display.newRect(display.contentWidth/2, 4*height+45, 150, 30)
		...
		local advisingTime5 = display.newText("9:55 - 10:15", cell3.x - 120, cell3.y, nil, 10)
	...
	local cell4 = display.newRect(display.contentWidth/2, 5*height+60, 150, 30)
		...
		local breakTime5 = display.newText("10:15 - 10:35", cell4.x - 120, cell4.y, nil, 10)
	...
	local cell5 = display.newRect(display.contentWidth/2, 6*height+75, 150, 30)
		local dBandText5 = display.newText("D Band", display.contentWidth/2, cell5.y, nil, 16)
		local dBandTime5 = display.newText("10:35 - 11:25", cell5.x - 120, cell5.y, nil, 10)
	...
	local cell6 = display.newRect(display.contentWidth/2, 7*height+90, 150, 30)
		local aBandText5 = display.newText("A Band", display.contentWidth/2, cell6.y, nil, 16)
		local aBandTime5 = display.newText("11:30 - 12:20", cell6.x - 120, cell6.y, nil, 10)
	...
	local cell8 = display.newRect(display.contentWidth/2, 9*height+120, 150, 30)
		...
		local communityTime5 = display.newText("1:00 - 1:45", cell8.x - 120, cell8.y, nil, 10)
	...
	local cell9 = display.newRect(display.contentWidth/2, 10*height+135, 150, 30)
		local fBandText5 = display.newText("F Band", display.contentWidth/2, cell9.y, nil, 16)
		local fBandTime5 = display.newText("1:45 - 3:15", cell9.x - 120, cell9.y, nil, 10)
