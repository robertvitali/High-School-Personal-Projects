...
function scene:create (event)
	...
	local cell1 = display.newRect(display.contentWidth/2, 2*height + 15, 150, 30)
		local fBandText2 = display.newText("F Band", display.contentWidth/2, cell1.y, nil, 16)
		local fBandTime2 = display.newText("8:10 - 8:55", cell1.x - 120, cell1.y, nil, 12)
	...
	local cell2 = display.newRect(display.contentWidth/2, 3*height + 30, 150, 30)
		local gBandText2 = display.newText("G Band", display.contentWidth/2, cell2.y, nil, 16)
		local gBandTime2 = display.newText("9:00 - 9:45", cell2.x - 120, cell2.y, nil, 12)
	...
	local cell3 = display.newRect(display.contentWidth/2, 4*height + 45, 150, 30)
		...
		local advisingTime2 = display.newText("9:50 - 10:10", cell3.x - 120, cell3.y, nil, 12)
	...
	local cell4 = display.newRect(display.contentWidth/2, 5*height + 60, 150, 30)
		...
		local breakTime2 = display.newText("10:10 - 10:30", cell4.x - 120, cell4.y, nil, 12)
	...
	local cell5 = display.newRect(display.contentWidth/2, 6*height +75, 150, 30)
		local aBandText2 = display.newText("A Band", display.contentWidth/2, cell5.y, nil, 16)
		local aBandTime2 = display.newText("10:35 - 11:25", cell5.x - 120, cell5.y, nil, 12)
		if(UserInfo.aBand ~= "")then
			aBandText2.text = UserInfo.aBand
		end

	local cell6 = display.newRect(display.contentWidth/2, 7*height + 90, 150, 30)
		local bBandText2 = display.newText("B Band", display.contentWidth/2, cell6.y, nil, 16)
		local bBandTime2 = display.newText("11:30 - 12:20", cell6.x - 120, cell6.y, nil, 12)
	...
	local cell8 = display.newRect(display.contentWidth/2, 9*height + 120, 150, 30)
		...
		local communityTime2 = display.newText("1:05 - 1:45", cell8.x - 120, cell8.y, nil, 12)
	...
	local cell9 = display.newRect(display.contentWidth/2, 10*height +135, 150, 30)
		...
		local cBandTime2 = display.newText("1:50 - 3:20", cell9.x - 120, cell9.y, nil, 12)
	...
	aBandText2:setFillColor(0.6,0,0)
	cell6.strokeWidth = 2
	...
	dayGroup2:insert(aBandText2)
	dayGroup2:insert(aBandTime2)
