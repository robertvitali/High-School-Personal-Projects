...
function scene:create (event)
	...
	local cell1 = display.newRect(display.contentWidth/2, 2*height + 15, 150, 30)
		local dBandText3 = display.newText("D Band", display.contentWidth/2, cell1.y, nil, 16)
		local dBandTime3 = display.newText("8:10 - 8:55", cell1.x - 120, cell1.y, nil, 12)
	...
	local cell2 = display.newRect(display.contentWidth/2, 3*height + 30, 150, 30)
		local eBandText3 = display.newText("E Band", display.contentWidth/2, cell2.y, nil, 16)
		local eBandTime3 = display.newText("9:00 - 9:45", cell2.x - 120, cell2.y, nil, 12)
	...
	local cell3 = display.newRect(display.contentWidth/2, 4*height + 45, 150, 30)
		...
		local advisingTime3 = display.newText("9:50 - 10:10", cell3.x - 120, cell3.y, nil, 12)
	...
	local cell4 = display.newRect(display.contentWidth/2, 5*height +60, 150, 30)
		...
		local breakTime3 = display.newText("10:10 - 10:30", cell4.x - 120, cell4.y, nil, 12)
	...
	local cell5 = display.newRect(display.contentWidth/2, 6*height + 75, 150, 30)
		local fBandText3 = display.newText("F Band", display.contentWidth/2, cell5.y, nil, 16)
		local fBandTime3 = display.newText("10:35 - 11:25", cell5.x - 120, cell5.y, nil, 12)
	...
	local cell6 = display.newRect(display.contentWidth/2, 7*height + 90, 150, 30)
		local gBandText3 = display.newText("G Band", display.contentWidth/2, cell6.y, nil, 16)
		local gBandTime3 = display.newText("11:30 - 12:20", cell6.x - 120, cell6.y, nil, 12)
		if(UserInfo.gBand ~= "")then
			gBandText3.text = UserInfo.gBand
		end
	...
	local cell8 = display.newRect(display.contentWidth/2, 9*height+120, 150, 30)
		...
		local communityTime3 = display.newText("1:05 - 1:45", cell8.x - 120, cell8.y, nil, 12)
	...
	local cell9 = display.newRect(display.contentWidth/2, 10*height + 135, 150, 30)
		local aBandText3 = display.newText("A Band", display.contentWidth/2, cell9.y, nil, 16)
		local aBandTime3 = display.newText("1:50 - 3:20", cell9.x - 120, cell9.y, nil, 12)
		if(UserInfo.dBand ~= "")then
			aBandText3.text = UserInfo.aBand
		end
	...
	gBandText3:setFillColor(0.6,0,0)
	cell7.strokeWidth = 2
	...
	aBandText3:setFillColor(0.6,0,0)
	...
	cell5:addEventListener("tap", fBandTouch)
	cell6:addEventListener("tap", gBandTouch)
