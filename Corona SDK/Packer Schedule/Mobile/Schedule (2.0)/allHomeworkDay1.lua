...
function scene:create (event)
	...
	local temp = display.newText("All Notes from Day 1", display.contentWidth/2, display.contentHeight-450, native.systemFont, 24)
	...
	notes1.text = UserInfo.aBand.." Homework: "..UserInfo.aBandHomework
	...
	notes2.text = UserInfo.bBand.." Homework: "..UserInfo.bBandHomework
	...
	notes5.text = UserInfo.cBand.." Homework: "..UserInfo.cBandHomework
	...
	notes9.text = UserInfo.eBand.." Homework: "..UserInfo.eBandHomework
