...
function scene:create (event)
	...
	local temp = display.newText("All Notes from Day 2", display.contentWidth/2, display.contentHeight-450, native.systemFont, 24)
