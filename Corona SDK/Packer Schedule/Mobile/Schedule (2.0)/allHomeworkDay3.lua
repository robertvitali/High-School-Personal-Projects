...
function scene:create (event)
	...
	local temp = display.newText("All Notes from Day 3", display.contentWidth/2, display.contentHeight-450, native.systemFont, 24)
	...
	notes5.text = UserInfo.fBand.." Homework: "..UserInfo.fBandHomework
