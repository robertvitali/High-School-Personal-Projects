...
function scene:create (event)
	...
	local temp = display.newText("All Notes from Day 4", display.contentWidth/2, display.contentHeight-450, native.systemFont, 24)
	...
	if(UserInfo.dBand == "") then
		UserInfo.dBand = "B Band"
	end
	local notes1 = native.newTextBox(display.contentWidth/2, notesText.y + startHeight9, 310, 50)
	notes1.text = UserInfo.bBand.." Homework: "..UserInfo.bBandHomework
	...
	if(UserInfo.aBand == "") then
		UserInfo.aBand = "C Band"
	end
	local notes2 = native.newTextBox(display.contentWidth/2, notesText.y + 2*startHeight9, 310, 50)
	notes2.text = UserInfo.cBand.." Homework: "..UserInfo.cBandHomework
	notes2:setTextColor(1,1,1)
	...
	local notes3 = native.newTextBox(display.contentWidth/2, notesText.y + 3*startHeight9, 310, 50)
	notes3.text = UserInfo.advising.." Notes: "..UserInfo.advisingTasks
	notes3:setTextColor(1,1,1)
	...
	local notes4 = native.newTextBox(display.contentWidth/2, notesText.y + 4*startHeight9, 310, 50)
	notes4.text = UserInfo.myBreak.." Notes: "..UserInfo.breakTasks
	notes4:setTextColor(1,1,1)
	notes4.isEditable = false
	notes4.hasBackground = false
	notes4.size = 18

	if(UserInfo.gBand == "") then
		UserInfo.gBand = "D Band"
	end
	local notes5 = native.newTextBox(display.contentWidth/2, notesText.y + 5*startHeight9, 310, 50)
	notes5.text = UserInfo.dBand.." Homework: "..UserInfo.dBandHomework
	notes5:setTextColor(1,1,1)
	notes5.isEditable = false
	notes5.hasBackground = false
	notes5.size = 18

	if(UserInfo.cBand == "") then
		UserInfo.cBand = "E Band"
	end
	local notes6 = native.newTextBox(display.contentWidth/2, notesText.y + 6*startHeight9, 310, 50)
	notes6.text = UserInfo.eBand.." Homework: "..UserInfo.eBandHomework
	notes6:setTextColor(1,1,1)
	...
	local notes7 = native.newTextBox(display.contentWidth/2, notesText.y + 7*startHeight9, 310, 50)
	notes7.text = UserInfo.lunch.." Notes: "..UserInfo.lunchTasks
	notes7:setTextColor(1,1,1)
	...
	local notes8 = native.newTextBox(display.contentWidth/2, notesText.y + 8*startHeight9, 310, 50)
	notes8.text = UserInfo.community.." Notes: "..UserInfo.communityTasks
	notes8:setTextColor(1,1,1)
	notes8.isEditable = false
	notes8.hasBackground = false
	notes8.size = 18

	if(UserInfo.eBand == "") then
		UserInfo.eBand = "F Band"
	end
	local notes9 = native.newTextBox(display.contentWidth/2, notesText.y + 9*startHeight9, 310, 50)
	notes9.text = UserInfo.fBand.." Homework: "..UserInfo.fBandHomework
	notes9:setTextColor(1,1,1)
