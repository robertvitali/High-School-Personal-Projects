...
function scene:create (event)
	...
	local temp = display.newText("All Notes from Day 5", display.contentWidth/2, display.contentHeight-450, native.systemFont, 24)
	...
	notes5.text = UserInfo.bBand.." Homework: "..UserInfo.bBandHomework
	...
	notes6.text = UserInfo.cBand.." Homework: "..UserInfo.cBandHomework
