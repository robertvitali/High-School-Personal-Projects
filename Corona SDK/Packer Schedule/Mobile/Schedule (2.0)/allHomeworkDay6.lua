...
function scene:create (event)
	...
	local temp = display.newText("All Notes from Day 6", display.contentWidth/2, display.contentHeight-450, native.systemFont, 24)
	...
	notes1.text = UserInfo.eBand.." Homework: "..UserInfo.eBandHomework
	...
	notes6.text = UserInfo.aBand.." Homework: "..UserInfo.aBandHomework
