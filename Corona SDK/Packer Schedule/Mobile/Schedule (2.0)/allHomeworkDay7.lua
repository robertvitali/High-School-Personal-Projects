...
function scene:create (event)
	...
	local temp = display.newText("All Notes from Day 7", display.contentWidth/2, display.contentHeight-450, native.systemFont, 24)
	...
	notes1.text = UserInfo.cBand.." Homework: "..UserInfo.cBandHomework
	...
	notes9.text = UserInfo.gBand.." Homework: "..UserInfo.gBandHomework
