...
function scene:create (event)
	...
	text3 = display.newText("Elite", circle5.x, circle5.y, native.systemFont, 40)
	...
	text4 = display.newText("Insructions", circle7.x, circle7.y, native.systemFont, 38)
	...
	function play()
		composer.gotoScene("startScreen1", {effect = "zoomInOutFade", time = 380} )
	end
