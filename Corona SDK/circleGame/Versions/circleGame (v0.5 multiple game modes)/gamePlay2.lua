...
function scene:create (event)
	...
	function highScore()
		if (score > UserInfo.highScoreEP1) then
			UserInfo.highScoreEP3 = UserInfo.highScoreEP2
			UserInfo.highScoreEP2 = UserInfo.highScoreEP1
			UserInfo.highScoreEP1 = score
		elseif (score > UserInfo.highScoreEP2) then
			UserInfo.highScoreEP3 = UserInfo.highScoreEP2
			UserInfo.highScoreEP2 = score
		elseif (score > UserInfo.highScoreEP3) then
			UserInfo.highScoreEP3 = score
		end
