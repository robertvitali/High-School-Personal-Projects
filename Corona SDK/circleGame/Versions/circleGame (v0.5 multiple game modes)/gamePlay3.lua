...
function scene:create (event)
	...
	scoreText = display.newText("Score: "..score, width, height/8 - 80, native.systemFont, 60)
	countdownText = display.newText("Time Left: "..countdown, width, height/8, native.systemFont, 60)
	radomizeNumbers2()
