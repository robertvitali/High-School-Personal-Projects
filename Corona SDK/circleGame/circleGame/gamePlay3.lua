...
function scene:create (event)
	...
	scoreText = display.newText("Score: "..score, width, height/8 - 80, native.systemFont, display.contentHeight/18)
		scoreText.y = scoreText.y + scoreText.height
	countdownText = display.newText("Time Left: "..countdown, width, scoreText.y, native.systemFont, display.contentHeight/18)
		countdownText.y = countdownText.y + countdownText.height
	radomizeNumbers2()

	resetButton = display.newText("Reset", width, height*1.95, native.systemFont, display.contentHeight/28)
	backButton = display.newText("<", width/6, (height/8) - 80, native.systemFont, display.contentHeight/28)
	...
	playScreenGroup:insert(countdownText)
	...
	timer2 = timer.performWithDelay(1000, timeDown, 0)

	function checkClick(event)
		if (randomNumText == randomNumCircle)then
			score = score + 1
			if timerNumber > 600 then
